...
#https://stats.stackexchange.com/questions/258721/gradient-ascent-vs-gradient-descent-in-logistic-regression
import numpy as np
def loadDataSet():
    dataMat = [];labelMat = []
    fr = open('testSet.txt')
...
def colicTest():
    ...
    print "the errort rate of this test is: %f" % errorRate
    return errorRate
